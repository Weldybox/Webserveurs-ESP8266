...
/*--------------------------------------------------------------------------------
Fonction de vérification qui permet de lire dans le fichier data.csv pour vérifier
qu'il y a bien des publications de température
--------------------------------------------------------------------------------*/
/*void readdata(){
...
*/
/*--------------------------------------------------------------------------------
Fonction qui ajoute tous les X secondes une valeure de température assocé à une heure
--------------------------------------------------------------------------------*/
/*void adddata(float temperature) {
